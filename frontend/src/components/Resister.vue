          ...
          <form>
            <table>
              ...
              <tr>
                <td>입고개수</td>
                <td id='calc'>
                  <!-- <div><input tpye="number" size="10" name='count' :value='count' v-model='count'></div> -->
                  <div>에러난 지점 <input type="text"></div>
                  <div id='btn'>
              ...
              <tr>
                <td>거래처</td>
                <td><input type='text' name='p_trade' @keyup.enter='TradeName'> </td>
...
<style>
  #resister {width:1100px; min-width:1050px; margin:0 auto;}
  #resister table {}
